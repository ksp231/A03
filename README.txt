...
Branch: Branches allow you to make changes to a repository without affecting the entire thing.
Clone: Allows the file to be saved to Webstorm and then edited.
Commit: Changes saved to the file.
Fetch: Downloads files, commits, and refs from a remote repository into a local repository (6)
GIT: Git is an open source version control system which lets you track changes made to files
Github: A website that allows users to connect their files and create repositories
Merge: Combine multiple changes
Merge Conflict: When you merge branches that have different commits, there is a conflict, like two conflicting stories on the same topic. The user must resolve these changes. (5)
Push: Sending the changes to GitHub (1)
Pull: Downloads content from a repository (6)
Remote: Remote lets you connect to other repositories (6)
Repository: Collections of files in all edited states (7)
